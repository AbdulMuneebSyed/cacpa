...
function OrbitingCirclesDemo() {
  return (
    <div className="relative flex md:pb-10 h-screen w-full flex-col items-center justify-center  overflow-hidden rounded-lg border bg-white md:shadow-xl">
      <span className="whitespace-pre-wrap bg-gradient-to-b from-[#3f5964] to-[#19b2b0] bg-clip-text text-center text-3xl font-semibold leading-none text-transparent dark:from-white dark:to-black">
        Our Services
      </span>
      ...
      >
        <Image
          ...
          height={100} // Set the height of the image
        />
        <span className=" bg-gradient-to-b text-black w-40 from-black bg-clip-text  text-xs font-semibold text-center text-transparent dark:from-white dark:to-black">
          Web Development & Hosting Services
        </span>
      </OrbitingCircles>
