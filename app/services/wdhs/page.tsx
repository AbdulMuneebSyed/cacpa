...
import { DomainVisualizer } from "@/components/domain-visualizer";
    ...
    <div className="min-h-screen max-w-screen overflow-hidden bg-[#3f5964]">
          ...
          >
            <div className="space-y-6">
              ...
              >
                Web Development
                <br />
                <span className="text-[#19b2b0]">&</span> Hosting Services
              </motion.h1>
      ...
      <section ref={containerRef} className="relative py-24">
        <motion.div
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%2319b2b0' fill-opacity='0.1'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
            y,
          }}
        />
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <motion.div
                ...
                className="group relative overflow-hidden rounded-lg bg-[#3f5964]/50 p-6 backdrop-blur-sm"
              >
                <div className="absolute inset-0 z-[-10] bg-gradient-to-r from-[#19b2b0]/10 to-[#3f5964]/30 opacity-0 transition-opacity group-hover:opacity-100" />
                <service.icon className="mb-4 h-8 w-8 text-[#19b2b0]" />
            ...
            >
              ...
              <Link href="/contactus" className="z-10">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="rounded-full bg-[#19b2b0] px-8 py-3 font-semibold text-white transition-colors hover:cursor-pointer hover:bg-[#19b2b0]/80"
                >
                  Get Started
                </motion.button>
              </Link>
