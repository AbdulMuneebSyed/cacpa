    ...
    navs: [
      {
        ...
        desc: "Strategic guidance for business success",
        path: "/services/bmc",
        icon: (
          <svg
      ...
      },
      {
        ...
        desc: "Managing workforce for organizational success",
        path: "/services/hrm",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      },
      {
        ...
        desc: "Efficient organization of storage operations",
        path: "/services/wm",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      },
      {
        ...
        desc: "Creating and hosting websites efficiently",
        path: "/services/wdhs",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
